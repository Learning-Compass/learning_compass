...
out.println("<div class=\"itemDisplay\">");
//        out.println("<table class=\"table itemDisplayTable\">");
        ...
        while (st.hasMoreTokens())
        {
            ...
            if (values.length > 0)
            {
                out.print("<div class=\"metadataFieldLabels\" id=\"metadatafl_"+element+"\">");
                
//                out.print("<tr class=\""+element+"\"><td class=\"metadata_"+element+"_FieldLabel\">");
                ...
                out.print(label);
                out.print("</div>");
                out.print("<div class=\"metadataFieldValue\" id=\"metadatafv_"+element+"\">");
//                out.print(":&nbsp;</td><td class=\"metadata_"+element+"_FieldValue\">");
