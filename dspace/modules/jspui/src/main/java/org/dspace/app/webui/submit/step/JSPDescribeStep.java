...
/**
 * Describe step for DSpace JSP-UI submission process. Handles the pages that
 * gather descriptive information (i.e. metadata) for an item being submitted
 * into DSpace.
 * <P>
 * This JSPStep class works with the SubmissionController servlet for the
 * JSP-UI.
 * <P>
...
public class JSPDescribeStep extends JSPStep {
    ...
    public void doPreProcessing(Context context, HttpServletRequest request,
        ...
        log.info("COMPASS: doPreProcessing....");

        Enumeration attributeNamesEnumeration = request.getAttributeNames();
    ...
    public void doPostProcessing(Context context, HttpServletRequest request,
        ...
        log.info("COMPASS: doPostProcessing....");
